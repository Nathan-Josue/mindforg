...
export function Safari({
    ...
    return (
        <div className="relative">
            ...
            {children && (
                <div
                    className="absolute bg-white dark:bg-[#262626] overflow-hidden"
                    style={{
                        top: "52px",
                        left: "1px",
                        width: `${width - 2}px`,
