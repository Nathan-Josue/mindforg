...
export default function Language() {
    ...
    return (
        <div className="relative py-4 px-4">
            <h2 className="ml-8 text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-4">
                Langages
            </h2>
            ...
            <div className="relative">
                ...
                <button
                    onClick={scrollLeft}
                    className="ml-2 absolute left-0 top-1/2 -translate-y-1/2 z-10 bg-gray-700 text-white p-2 rounded-lg hover:bg-gray-600 h-10 w-10
                ...
                <button
                    onClick={scrollRight}
                    className="mr-2 absolute right-0 top-1/2 -translate-y-1/2 z-10 bg-gray-700 text-white p-2 rounded-lg hover:bg-gray-600 h-10 w-10
                     hover:ring-3 hover:ring-white hover:ring-offset-2 hover:ring-offset-[#27262A] hover:scale-105 transition-all duration-300 cursor-pointer"
                >
                    <ChevronRight />
                </button>
                ...
                <div
                    ref={scrollRef}
                    className="overflow-x-auto no-scrollbar flex flex-nowrap gap-4 py-4"
                >
                    {LanguegesData.map((lang) => (
                        <button
                            key={lang.id}
